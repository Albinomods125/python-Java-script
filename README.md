...
JavaScript é uma linguagem de programação criada inicialmente para rodar no
navegador, mas hoje funciona também no backend (servidor) graças ao Node.js.

Ele permite:

- Criar páginas interativas
- Criar aplicativos web completos
- Automatizar tarefas
- Construir APIs e servidores
- Desenvolver aplicações mobile e desktop

### Como o JavaScript funciona?

JavaScript é **single-thread**, **interpretado** e **assíncrono**.
